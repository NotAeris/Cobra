...
public class GamemodeCommand {
    ...
    public void execute(CommandArgs args) {
        ...
        if(args.length() == 0) {
            sender.sendMessage(CC.translate(CobraPlugin.get().getConfig().getString("command.gamemode.usage"))
            ...
            if(args.getArgs(0).equalsIgnoreCase("survival") || args.getArgs(0).equalsIgnoreCase("s") || args.getArgs(0).equalsIgnoreCase("0")) {
                ...
                sender.sendMessage(CC.translate(CobraPlugin.get().getConfig().getString("command.gamemode.updated"))
